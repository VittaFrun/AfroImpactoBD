...
export class AfroimpactoDb1760641314396 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Tabla rol (con campos adicionales)
        ...
        // Tabla organizacion (con campos adicionales)
        ...
        // Tabla proyecto (con campos adicionales)
        ...
        // Tabla asignacion (con id_rol en lugar de rol_asignado)
        ...
        // Tabla reporte (con campos adicionales)
        ...
        // Triggers para validación de roles (usando raw SQL sin DELIMITER)
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        // Drop foreign keys - nuevas tablas
