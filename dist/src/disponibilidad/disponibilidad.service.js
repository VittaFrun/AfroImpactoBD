...
const disponibilidad_entity_1 = require("./disponibilidad.entity");
let DisponibilidadService = class DisponibilidadService {
    ...
    async update(id, updateDisponibilidadDto) {
...
exports.DisponibilidadService = DisponibilidadService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(disponibilidad_entity_1.Disponibilidad)),
