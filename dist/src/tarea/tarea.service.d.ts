...
export declare class TareaService {
    ...
    constructor(repo: Repository<Tarea>, faseRepo: Repository<Fase>, proyectoRepo: Repository<Proyecto>, orgRepo: Repository<Organizacion>, voluntarioRepo: Repository<Voluntario>, asignacionRepo: Repository<Asignacion>);
    ...
    update(id: number, dto: UpdateTareaDto, user: Usuario): Promise<import("typeorm").UpdateResult>;
