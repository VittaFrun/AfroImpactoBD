...
exports.SchemaSync1755804694542 = void 0;
class SchemaSync1755804694542 {
    constructor() {
        this.name = 'SchemaSync1755804694542';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`proyecto\` ADD \`id_organizacion\` int NOT NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`proyecto\` DROP COLUMN \`id_organizacion\``);
...
exports.SchemaSync1755804694542 = SchemaSync1755804694542;
//# sourceMappingURL=1755804694542-SchemaSync.js.map